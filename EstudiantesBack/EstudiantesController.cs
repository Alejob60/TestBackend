...
namespace EstudiantesBack
{
    [Route("api/[controller]")]
    [ApiController]
    public class EstudiantesController : ControllerBase
    {
        private readonly EstudiantesBackContext _context;

        public EstudiantesController(EstudiantesBackContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Estudiante>> PostEstudiante(Estudiante estudiante)
        {
          if (_context.Estudiante == null)
          {
              return Problem("Entity set 'EstudiantesBackContext.Estudiante'  is null.");
          }
